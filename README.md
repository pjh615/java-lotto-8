...
- **2. 구입한 개수 출력 및 번호 출력**
- **3. 당첨 번호 입력**
  - **3-1.** 당첨 번호를 쉼표(`,`)를 기준으로 분리
  - **3-2.** 당첨 번호의 범위 검사
  - **3-3.** 당첨 번호의 중복 검사
- **4. 보너스 번호 입력**
  - **4-1.** 보너스 번호의 범위 검사
  - **4-2.** 보너스 번호와 당첨 번호의 중복 검사
- **5. 당첨 통계 출력**
- **6. 당첨 내역 출력**
- **7. 수익률 출력**
### 로또 당첨 판단
- **1. 생성된 로또와 당첨 번호 일치 판단**
- **2. 생성된 로또와 보너스 번호 일치 판단**
- **3. 당첨 여부 판단**
- **4. 남은 로또에 대해서 반복**
- **5. 수익률 계산**
...
- 로또 구입 금액은 1,000원 단위의 양의 정수(구입 금액)를 입력한다.
- 당첨 번호는 1부터 45까지의 중복되지 않은 정수 6개를 쉼표(,)로 구분해 입력한다.
- 보너스 번호는 1부터 45까지의 당첨 번호와 중복되지 않는 정수를 1개를 입력한다.
...
- 0 혹은 음수의 로또 구입 금액 입력
- 1,000으로 나누어 떨어지지 않는 로또 구입 금액 입력
- 6개 미만/초과인 당첨 번호 입력
- 당첨 번호/보너스 번호의 범위가 1부터 45까지를 벗어나는 입력
- 문자가 포함된 입력
